...
After retrieval, the results are reranked using the cross encoder model bge-reranker-base \cite{reranker_model}
...
The human evaluation results were obtained by 3 evaluators (authors), who evaluated the answers on a scale from 1 to 5, regarding 7 predetermined categories. The results are shown in the Table \ref{tab:human_eval}.
